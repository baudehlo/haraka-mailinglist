...
exports.find_list = function (listname, callback) {
    var sql = "SELECT id, email, name FROM List WHERE email = $1";
...
exports.is_member = function (user_id, list, callback) {
    var sql = "SELECT list_id, user_id FROM ListMember WHERE list_id = $1 AND user_id = $2";
...
exports.get_members = function (list, callback) {
    var sql = "SELECT email, name FROM ListUser, ListMember WHERE user_id = ListUser.id AND list_id = $1";
...
exports.add_member = function (list_id, user_id, cb) {
    var sql = "INSERT INTO ListMember (list_id, user_id) SELECT $1, $2 " +
...
exports.remove_member = function (list_id, user_id, cb) {
    var sql = "DELETE FROM ListMember WHERE list_id = $1 AND user_id = $2";
